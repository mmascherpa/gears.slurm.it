...
const CACHE_NAME = 'slurm-cache-2025-11-24T23-08-33';
const urlsToCache = [
    '/',
    '/index.html',
    '/manifest.json',
    ...
    '/assets/About-BZaixcwW.js',
    '/assets/AesDecrypt-NSof6BiY.js',
    '/assets/AesEncrypt-P2QCW2_g.js',
    '/assets/Base64Decode-YsGV5Iub.js',
    '/assets/Base64Encode-CGXaRtkE.js',
    '/assets/CardSectionHeader-CxQSuQv0.js',
    '/assets/CsvPreviewTable-CVo4TOOC.js',
    '/assets/EducationalAlert-DkUlmwt3.js',
    '/assets/FileUpload-D9EThhA_.js',
    '/assets/HexViewer-D--TtB8F.js',
    '/assets/InfoTooltip-Cp24ufGm.js',
    '/assets/MetadataEditor-Di8QE7pU.js',
    '/assets/PasswordGenerator-DGTh37Ia.js',
    '/assets/PasswordInput-B8JL8r9z.js',
    '/assets/PasswordStrengthIndicator-BC1YKonA.js',
    '/assets/QrCodeGenerator-K0M4DSKw.js',
    '/assets/TextInputWithActions-kl_sTwEg.js',
    '/assets/ToolPageHeader-BJQ7B0XN.js',
    '/assets/fileDownload-B1vhVzTR.js',
    '/assets/index-B-OSmdDu.js',
    '/assets/useClipboard-KqVwDR14.js',
    '/assets/useDebounce-CPmkfBar.js',
