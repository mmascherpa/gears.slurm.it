...
const CACHE_NAME = 'slurm-cache-2025-11-23T17-15-43';
const urlsToCache = [
    '/',
    '/index.html',
    '/manifest.json',
    ...
    '/assets/About-_kv2pVdp.js',
    '/assets/AesDecrypt-D33QCg5w.js',
    '/assets/AesEncrypt-2i5FWSPB.js',
    '/assets/Base64Decode-Bq4T4IFX.js',
    '/assets/Base64Encode-DJqQLlG6.js',
    '/assets/CardSectionHeader-B739stJ-.js',
    '/assets/CsvPreviewTable-CqFZZzCF.js',
    '/assets/FileUpload-BDujieA5.js',
    '/assets/HexViewer-7dGmq3u1.js',
    '/assets/MetadataEditor-CUfuhrq5.js',
    '/assets/PasswordGenerator-COGYDcXv.js',
    '/assets/PasswordInput-BL-9FnSo.js',
    '/assets/PasswordStrengthIndicator-BgFDiEVo.js',
    '/assets/QrCodeGenerator-DQNUWAi7.js',
    '/assets/TextInputWithActions-Ca2jwfS9.js',
    '/assets/ToolPageHeader-TgTx7KLi.js',
    '/assets/fileDownload-B1vhVzTR.js',
    '/assets/index-Be9HKwpV.js',
    '/assets/useClipboard-KqVwDR14.js',
    '/assets/useDebounce-CBVJKzh1.js',
    ...
    '/assets/MetadataEditor-CO6e2k_C.css',
