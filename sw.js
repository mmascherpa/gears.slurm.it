...
const CACHE_NAME = 'slurm-cache-2025-11-24T01-48-53';
const urlsToCache = [
    '/',
    '/index.html',
    '/manifest.json',
    ...
    '/assets/About-pBhIwvYy.js',
    '/assets/AesDecrypt-CcU07tLi.js',
    '/assets/AesEncrypt-DVv5LhAU.js',
    '/assets/Base64Decode-CDD2Jstv.js',
    '/assets/Base64Encode-b0JO1lol.js',
    '/assets/CardSectionHeader-WtJNbN4j.js',
    '/assets/CsvPreviewTable-CXX7_feK.js',
    '/assets/EducationalAlert-C_kvOME0.js',
    '/assets/FileUpload-pDvth4ic.js',
    '/assets/HexViewer-xcis23Wr.js',
    '/assets/InfoTooltip-UEis1O_4.js',
    '/assets/MetadataEditor--bYIsH0V.js',
    '/assets/PasswordGenerator-C3yaxZif.js',
    '/assets/PasswordInput-CRJZR1lR.js',
    '/assets/PasswordStrengthIndicator-T4fvWBXg.js',
    '/assets/QrCodeGenerator-BwHNUdb1.js',
    '/assets/TextInputWithActions-1ReWWzLH.js',
    '/assets/ToolPageHeader-Dl1bk7KP.js',
    '/assets/fileDownload-B1vhVzTR.js',
    '/assets/index-CWG1oA9_.js',
    '/assets/useClipboard-KqVwDR14.js',
    '/assets/useDebounce-DZklv19J.js',
