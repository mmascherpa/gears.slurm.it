...
const CACHE_NAME = 'slurm-cache-2026-01-21T02-13-44';
const urlsToCache = [
    '/',
    '/index.html',
    '/manifest.json',
    ...
    '/assets/About-Djtusqo3.js',
    '/assets/Base64Decode-B1VUgNIQ.js',
    '/assets/Base64Encode--RwrQQm-.js',
    '/assets/CardSectionHeader-rfamhgyu.js',
    '/assets/CsvPreviewTable-BMBUPjQu.js',
    '/assets/Decrypt-B2JKwlfb.js',
    '/assets/EducationalAlert-Z7WFHq04.js',
    '/assets/Encrypt-BozGM_wf.js',
    '/assets/FileUpload-BTI_bZc9.js',
    '/assets/HexViewer-DNEC5JPG.js',
    '/assets/InfoTooltip-BFpW9KY-.js',
    '/assets/MetadataEditor-CizfwMbD.js',
    '/assets/NotFound-BC4IebYs.js',
    '/assets/PasswordGenerator-ZzB8rI20.js',
    '/assets/PasswordInput-k2LxuvAN.js',
    '/assets/PasswordManager-CcSyAfyB.js',
    '/assets/PasswordStrengthIndicator-CaVB0Qrk.js',
    '/assets/QrCodeGenerator-Cj4VVv53.js',
    '/assets/TextInputWithActions-DFbxHJqB.js',
    '/assets/ToolPageHeader-BI_QYBdR.js',
    '/assets/cryptoWorker-DRYHjFPq.js',
    '/assets/fileDownload-B1vhVzTR.js',
    '/assets/index-CLKbXmT3.js',
    '/assets/passwordGenerator-DrRtYIk4.js',
    '/assets/useClipboard-KqVwDR14.js',
    '/assets/useDebounce-lrs_ZA3J.js',
